...
export default function ContactsIndex() {
  ...
  const columns = [
    ...
    { 
      ...
      sortable: true,
      render: (value: string) => {
        return window.superAdminSettings?.formatDateTime(value, true) || 
               window.appSettings?.formatDateTime(value, true) || 
  ...
  return (
    ...
    >
      ...
      <CrudFormModal
        ...
        formConfig={{
          fields: [
            { name: 'name', label: 'Name', type: 'text', required: true, placeholder: t('Enter contact name') },
            { name: 'email', label: 'Email', type: 'email', required: true, placeholder: t('Enter email address') },
            { name: 'subject', label: 'Subject', type: 'text', placeholder: t('Enter subject') },
            { name: 'message', label: 'Message', type: 'textarea', required: true, placeholder: t('Enter message') },
            { 
              name: 'status', 
              label: 'Status', 
              type: 'select', 
        ...
        title={formMode === 'create' ? t('Create Contact') : t('Edit Contact')}
        mode={formMode}
      />

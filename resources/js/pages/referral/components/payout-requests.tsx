...
export default function PayoutRequests({ userType, payoutRequests, settings, stats }: PayoutRequestsProps) {
  ...
  return (
    <div className="space-y-6">
      {userType === 'company' && (
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog} modal={!isChatGptOpen}>
              <DialogTrigger asChild>
                <Button disabled={!stats.availableBalance || stats.availableBalance < settings.threshold_amount}>
      ...
      <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog} modal={!isChatGptOpen}>
        <DialogContent>
          <DialogHeader>
